...
1. A copy of Abiotic Factor [**with UE4SS-AF and AbeLoader installed**](../../users/installing.md)
...
![Open folder in VS Code](/assets/screenshots/gettingstarted/vscode.png){width=40% align=right}
...
![FModel start menu](/assets/screenshots/gettingstarted/fmodel_start.png){width=50% align=right}
...
![FModel settings menu](/assets/screenshots/gettingstarted/fmodel_settings.png){width=80%}
/// caption
///
...
![FModel browser](/assets/screenshots/gettingstarted/fmodel_using.png){width=80%}
/// caption
///
